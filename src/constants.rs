...
pub const CODE_SERVER_ERROR_INTERNAL: &str = "server.error.internal";
pub const CODE_SEVER_ERROR_UNAUTHORIZED: &str = "server.error.unauthorized";
...
// ignore routes
pub const IGNORE_ROUTES: [&str; 1] = ["/api/auth/login"];
